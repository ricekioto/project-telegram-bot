...
public class ParsingHtmlService {
    ...
    public String parsingHtmlFromGenerationEnglishSentence(String html) throws ParsingHtmlException {
    ...
    public String parsingHtmlFromTranslator(String html) throws ParsingHtmlException {
        Document doc = Jsoup.parse(html);
